...
//                         <img
//                     src={ProfileImg}
//                     alt="Shekh Mohammad Faisal"
//                     className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-2 sm:border-4 border-white/30 shadow-xl sm:shadow-2xl"
//                   />
//                       </div>
//                     </div>
...
//                   <h1 
//                     className={`text-3xl font-bold text-white mb-3 ${isLoaded ? 'animate-fadeInLeft' : 'opacity-0'}`}
...
//                   <p 
//                     className={`text-white/90 text-base leading-relaxed max-w-sm mx-auto ${isLoaded ? 'animate-fadeInUp' : 'opacity-0'}`}
...
//                     <h1 
//                       className={`text-5xl font-bold text-white mb-4 ${isLoaded ? 'animate-fadeInLeft' : 'opacity-0'}`}
//                       style={{ animationDelay: '0.9s' }}
//                     >
//                       Shekh Mohammad Faisal
//                     </h1>
...
//                       <span className="text-white font-medium text-lg">Frontend Developer</span>
//                     </div>
                    
//                     <p 
//                       className={`text-white/90 text-xl leading-relaxed max-w-2xl ${isLoaded ? 'animate-fadeInUp' : 'opacity-0'}`}
//                       style={{ animationDelay: '1.5s' }}
//                     >
...
//                   <span className="gradient-text flex items-center justify-center">
//                     <FaEnvelope className="mr-3 animate-float" />
//                     Let's Work Together
//                   </span>
//                 </h3>
//                 <a
//                   href="mailto:shekhfaisal.2110@gmail.com"
//                   className="group relative inline-flex items-center justify-center w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl shimmer-overlay overflow-hidden"
//                 >
//                   <FaEnvelope className="mr-3 group-hover:animate-bounce relative z-10" />
//                   <span className="relative z-10 text-lg">Send me a message</span>
//                 </a>
//               </div>
...
//                       className={`group glass-morphism rounded-xl p-6 hover:scale-105 hover-glow transition-all duration-300 text-center ${isLoaded ? 'animate-scaleIn' : 'opacity-0'}`}
//                       style={{ animationDelay: `${2.3 + index * 0.1}s` }}
//                     >
//                       <div className={`w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-r ${social.bgGradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
